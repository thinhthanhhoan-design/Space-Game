...
export class Player { // Định nghĩa lớp Player quản lý phi thuyền người chơi
    ...
    update() {
        ...
        // Giới hạn chơi dựa trên kích thước cửa sổ (innerWidth/innerHeight) để đảm bảo tính phản hồi (responsive)
        // Chúng ta chia cho 80 để quy đổi từ pixel sang đơn vị 3D phù hợp với tầm nhìn của camera
