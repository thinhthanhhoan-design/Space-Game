...
export class ExplosionSystem {
  constructor(scene, camera) {
    ...
    // Danh sách hiệu ứng
    // ==============================
    this.particles = [];         // sparks, smoke, fire dust
  ...
  // SHIP HIT EFFECT
  // ====================================================
  spawnShipImpact(position, scale = 1.0) {
    this.spawnHitFlash(position, 1.0 * scale);
    this.spawnSparks(position, Math.floor(20 * scale), 2 * scale);
    this.spawnSmoke(position, Math.floor(25 * scale));
  }
